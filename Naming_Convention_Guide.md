...
| 44   | 未知控件       | DoraTemplate      | C        | 未有 |
| 45   | 未知控件       | DoraTemplate      | C        | 未有 |
| 46   | 未知控件       | DoraTemplate      | C        | 未有 |
| 47   | 未知控件       | DoraTemplate      | C        | 未有 |
| 48   | 未知控件       | DoraTemplate      | C        | 未有 |
| 49   | 未知控件       | DoraTemplate      | C        | 未有 |
| 50   | 未知控件       | DoraTemplate      | C        | 未有 |
| 51   | 未知控件       | DoraTemplate      | C        | 未有 |
| 52   | 未知控件       | DoraTemplate      | C        | 未有 |
| 53   | 未知控件       | DoraTemplate      | C        | 未有 |
| 54   | 未知控件       | DoraTemplate      | C        | 未有 |
...
| 74   | 语音波纹按钮     | DoraVoiceRippleButton    | C        | 未有 |
| 75   | 倒计时按钮       | DoraCountDownButton      | B        | 未有 |
| 76   | 弹幕显示控件     | DoraBarrageView          | C        | 未有 |
